...
protocol BottomBackgroundViewDelegate: class {
...
class BottomBackgroundView: UIView {
    ...
    weak var delegate: BottomBackgroundViewDelegate?
...
//        displayScreenLable.layoutMargins = UIEdgeInsets(top: 4, left: 16, bottom: 4, right: 16)
    ...
    func reloadView() {
        calculationResult = WinningNumberController.shared.getTotal()
        displayScreenLable.text = "\(calculationResult)"
    }
    @objc func clear() {
